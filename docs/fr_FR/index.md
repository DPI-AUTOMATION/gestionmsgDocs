...
![Image Configuration_Plugin](/docs/images/ConfPlugin.PNG)

# Configuration des équipements
La configuration des équipements gestionmsg est accessible à partir du menu plugin :

![Image Chemin Equipement](/docs/images/ConfEqChemin.PNG)


# Page d'Accueil

![Image Accueil Equipement](/docs/images/ConfEqAccueil.PNG)
...
![Image modal Gestion Destinataires](/docs/images/mdGestionDestinataires.PNG)
...
![Image modal Entete](/docs/images/mdGestionDestinatairesEx.PNG)
...
![Image Accueil Equipement](/docs/images/EqAccueil.PNG)
...
![Image Accueil Equipement](/docs/images/EqOngletGroup0.PNG)

1. Cliquer sur le bouton **Ajouter un groupe**
2. La fenêtre suivante s'ouvre pour saisir le nom du nouveau groupe: ex. TEST
   
   ![Image Accueil Equipement](/docs/images/EqOngletGroupNom.PNG)
 
4. le groupe est créé: ex.TEST
   
![Image Accueil Equipement](/docs/images/EqOngletGroup1.5.PNG)
...
![Image Accueil Equipement](/docs/images/EqOngletGroup2.PNG)

6. Selectionner les Destinataires et Sauvegarder. Le groupe est complété avec les destinataires selectionnés.

![Image Accueil Equipement](/docs/images/EqOngletGroup1.PNG)

**SAUVEGARDER TOUT en cliquant sur le bouton suivant:**

![Image BtnSauvegarderTout](/docs/images/SauvegarderGeneral.PNG)
...
![Image onglet message](/docs/images/EqOngletMsg0.PNG)
...
![Image onglet message après ajout](/docs/images/EqOngletMsg1.PNG)

4.maintenant il faut lui attribuer un groupe:

![Image onglet message select groupe](/docs/images/EqOngletMsgSelect.PNG)

5.Attribuer une commande: ex.le plugin mail est installée avec un equipement testMail.

![Image onglet message commande](/docs/images/EqOngletMsg1Zoom1.PNG)

6.Saisir un message: ex.test message Mail.

![Image onglet message message](/docs/images/EqOngletMsg1Zoom2.PNG)
...
# Widget du Plugin
![Image widget](/docs/images/Widget1.PNG)
